...
echo_and_run cd "/home/ubuntu/Desktop/miniRobot_rpi/src/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/Desktop/miniRobot_rpi/src/image_pipeline/camera_calibration/setup.py" \
    egg_info --egg-base /home/ubuntu/Desktop/miniRobot_rpi/build/image_pipeline/camera_calibration \
    build --build-base "/home/ubuntu/Desktop/miniRobot_rpi/build/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
