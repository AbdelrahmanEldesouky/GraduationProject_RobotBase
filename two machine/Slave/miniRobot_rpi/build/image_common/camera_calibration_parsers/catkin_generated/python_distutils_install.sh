...
echo_and_run cd "/home/ubuntu/Desktop/miniRobot_rpi/src/image_common/camera_calibration_parsers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/Desktop/miniRobot_rpi/src/image_common/camera_calibration_parsers/setup.py" \
    egg_info --egg-base /home/ubuntu/Desktop/miniRobot_rpi/build/image_common/camera_calibration_parsers \
    build --build-base "/home/ubuntu/Desktop/miniRobot_rpi/build/image_common/camera_calibration_parsers" \
    install \
    --root="${DESTDIR-/}" \
